...
export default function ThreadbuildCard() {
  ...
  const threadbuildAsset = getAssetByContentType('threadbuilder');

  if (!threadbuildAsset) return null;
      ...
      <CardContent className='p-2 sm:p-3 lg:p-4 flex-1 flex flex-col overflow-y-auto scrollbar-hide'>
        ...
        <div className='mb-4'>
          <p className='text-sm text-black'>
            <span className='font-semibold'>Description:</span> {threadbuildAsset.asset_description}
          </p>
        </div>
